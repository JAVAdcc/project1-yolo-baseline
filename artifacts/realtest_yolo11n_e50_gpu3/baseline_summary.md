...
- Converted samples: 24000
- Resumed samples skipped because outputs already existed: 0
- Removed duplicate label entries: 712
- Skipped samples: 0
- Skipped dataset.yaml update: False

## YOLO Conversion

- Input directory: /home/x/workspaces/yekai/wym/project1_yolo_baseline/data/raw/spacenet
- Output directory initialized at: /home/x/workspaces/yekai/wym/project1_yolo_baseline/data/processed/yolo_format_test_external
- Unsplit staging directories prepared at images/all and labels/all.
- Dataset file: /home/x/workspaces/yekai/wym/project1_yolo_baseline/data/raw/spacenet/test_full.h5
- Sample limit: all
- Current H5 parsing assumes labels are frequency-band lists and creates full-width YOLO boxes.
- Current class mapping is single-class detection: signal -> 0.
- Converted samples: 6000
- Resumed samples skipped because outputs already existed: 0
- Removed duplicate label entries: 313
- Skipped samples: 0
- Skipped dataset.yaml update: True
...
- Seed used for shuffle: 42
- Reset split directories: True
- External test input: /home/x/workspaces/yekai/wym/project1_yolo_baseline/data/processed/yolo_format_test_external
...
- Image size: 640
- Batch size: 16
- Training output: runs/train/realtest_yolo11n_e50_gpu3
- Best weights: runs/train/realtest_yolo11n_e50_gpu3/weights/best.pt
- Last weights: runs/train/realtest_yolo11n_e50_gpu3/weights/last.pt
- Model info: None
- Train report: runs/train/realtest_yolo11n_e50_gpu3/train_report.json
...
- Recall: 0.323029
- Latency benchmark device: cpu
- Latency mean (ms): 26.4626
- Latency median (ms): 26.5749

## Inference

- Prediction outputs: /home/x/workspaces/yekai/wym/project1_yolo_baseline/reports/figures/realtest_yolo11n_e50_gpu3_predictions
- Requested sample limit: 10
- Actual sample count: 10
- Result objects returned: 10
- Confidence threshold: 0.25
- Prediction manifest: reports/figures/realtest_yolo11n_e50_gpu3_predictions/prediction_manifest.json
...
- Class mapping: {'signal': 0}
- Metrics available: True
- mAP50: 0.35691756537677927
- mAP50-95: 0.2321507256340587
- Precision: 0.5954107469586145
- Recall: 0.32302873484951655
- Latency available: True
- Latency mean (ms): 26.4626
- Latency median (ms): 26.5749
- Latency device: cpu
- Best model size (MB): 5.19
- Training directory: /home/x/workspaces/yekai/wym/project1_yolo_baseline/runs/train/realtest_yolo11n_e50_gpu3
- Latest training row available: True
- Latest training row: {'                  epoch': '                     32', '         train/box_loss': '                 0.4556', '         train/cls_loss': '                0.54253', '         train/dfl_loss': '                0.82785', '   metrics/precision(B)': '                0.78548', '      metrics/recall(B)': '                0.54611', '       metrics/mAP50(B)': '                 0.6105', '    metrics/mAP50-95(B)': '                 0.4531', '           val/box_loss': '                 1.0679', '           val/cls_loss': '                0.93652', '           val/dfl_loss': '                0.88361', '                 lr/pg0': '               0.003862', '                 lr/pg1': '               0.003862', '                 lr/pg2': '               0.003862'}
- Train label stats: {'label_files': 19200, 'boxes': 56540, 'class_histogram': {'0': 56540}, 'width': {'min': 1.0, 'mean': 1.0, 'median': 1.0, 'max': 1.0}, 'height': {'min': 7.4e-05, 'mean': 0.108477, 'median': 0.02454, 'max': 0.490798}, 'aspect_ratio': {'min': 2.037498, 'mean': 121.284527, 'median': 40.749796, 'max': 13513.513514}}
- Val label stats: {'label_files': 4800, 'boxes': 14129, 'class_histogram': {'0': 14129}, 'width': {'min': 1.0, 'mean': 1.0, 'median': 1.0, 'max': 1.0}, 'height': {'min': 7.4e-05, 'mean': 0.107195, 'median': 0.02454, 'max': 0.490798}, 'aspect_ratio': {'min': 2.037498, 'mean': 130.860428, 'median': 40.749796, 'max': 13513.513514}}
- Test label stats: {'label_files': 6000, 'boxes': 29372, 'class_histogram': {'0': 29372}, 'width': {'min': 1.0, 'mean': 1.0, 'median': 1.0, 'max': 1.0}, 'height': {'min': 7.4e-05, 'mean': 0.106599, 'median': 0.024653, 'max': 0.493066}, 'aspect_ratio': {'min': 2.028126, 'mean': 452.832057, 'median': 40.563015, 'max': 13513.513514}}
- Named train class histogram: {'signal': 56540}
- Class imbalance ratio (max/min): 1.0
- Prediction manifest available: True
- Predicted class histogram: {'signal': 18}
- Zero-detection images: ['data/processed/yolo_format/images/test/sample_000003.png', 'data/processed/yolo_format/images/test/sample_000004.png', 'data/processed/yolo_format/images/test/sample_000009.png']
- Failure-case export remains provisional until full train.h5 reaches the remote machine.
